...
ansible-playbook $PROJECT_ROOT/app/devops/vagrant.yml --connection=local --extra-vars "project_name=$PROJECT_NAME project_hostname=$PROJECT_HOSTNAME project_root=$PROJECT_ROOT server_swap=$SERVER_SWAP"
