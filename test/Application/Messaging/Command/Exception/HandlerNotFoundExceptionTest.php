...
/**
 * @covers Novuso\Common\Application\Messaging\Command\Exception\HandlerNotFoundException
 */
class HandlerNotFoundExceptionTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        $exception = new HandlerNotFoundException('Handler not found');
        $this->assertSame(1102, $exception->getCode());
    }
    ...
    public function test_that_create_returns_exception_instance()
    {
        ...
        $this->assertInstanceOf(
            'Novuso\\Common\\Application\\Messaging\\Command\\Exception\\HandlerNotFoundException',
            $exception
        );
    }
}
