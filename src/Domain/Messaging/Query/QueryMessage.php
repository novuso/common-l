...
/**
 * QueryMessage is the message wrapper for a query
 *
 ...
 * @version   0.0.1
 */
class QueryMessage implements Message
{
    /**
     * Message ID
     *
    ...
    public static function deserialize(array $data)
    {
        ...
        $queryClass = Type::create($data['query_type'])->toClassName();
        $payload = $queryClass::deserialize($data['query_data']);
    ...
    public function serialize()
    {
        return [
            ...
            'query_type' => $this->payloadType->toString(),
            'query_data' => $this->payload->serialize(),
