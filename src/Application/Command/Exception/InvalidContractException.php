...
/**
 * InvalidContractException is thrown when referencing an invalid command
 *
 ...
 * @version   0.0.0
 */
class InvalidContractException extends CommandException
{
    /**
     * Constructs InvalidContractException
     *
     ...
     * @param Exception|null $previous The previous exception for chaining
     *
     * @return InvalidContractException
     */
